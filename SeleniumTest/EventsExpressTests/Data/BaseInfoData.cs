...
namespace SeleniumTest.EventsExpressTests.Data
{
    public class BaseInfoData
    {
        ...
        public static User Admin { get; } = new User { Email = "admin@gmail.com", Password = "1qaz1qaz" };
        public static User User { get; } = new User { Email = "user@gmail.com", Password = "1qaz1qaz" };
